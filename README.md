...
**Note:** The GUI applications are currently not available for MacOS, but you should be able to build them yourself using the instructions below under 'Rebuilding the GUI'
